...
<nav class="w3-sidenav w3-white w3-card-2 w3-animate-left" style="display:none;" id="mySidenav">
 ...
 <a href="c.php" style="font-size:24px; color:#11170d">C</a>
 <a href="c++.php" style="background:#97a0c3; font-size:20px">C++</a></h3>
...
<div class="w3-card-2" style="padding:20px 20px 20px 20px; background-color:#FFFFFF; margin-bottom:40px;">
	  ...
	  <p>C++ ranks 4th in popularity according to 2016 IEEE spectrum Top Programming Language ranking. Learning C++ is a wise investment for all programmers.</p>

<p>This guide answers all your questions related to C++ on what is it, when is it used, why is it used and how to get yourself started with it.</p>
</div>
...
<div class="banner-grid h3 w3-card-2">
	  ...
	  <div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">FLOW CONTROL<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-1-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
	   ...
	   $x=0;
      include("pro.php");
	  $rs=mysql_query("select * from cpplang where sub='cpp'");
	  while($r=mysql_fetch_array($rs)){
	  $x=$x+1;
	  if($r[4]=="FLOWCONTROL"){
	  ?>
				<p><a href="cpp_fullstory.php?id=<?=$r[4]?>&id1=<?=$r[2]?>" class="ad" style="color:#3f78cb">
  ...
  <?php
	  ...
	  <div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">FUNCTIONS <button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-2-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
  ...
  <?php
	  ...
	  <div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">STRUCTURES<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-3-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
  ...
  <div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">ARRAYS & STRING<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-4-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
...
<div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">OBJECT & CLASS<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-5-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
...
<div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">INHERITANCE<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-6-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
  ...
  <div class="accordation">
	   <div class="jb-accordion-wrapper">
				<div class="jb-accordion-title">POINTERS<button type="button" class="jb-accordion-button" data-toggle="collapse" data-target="#accordion-56-"><i class="fa fa-angle-down"> </i></button></div>
				<p><!-- /.accordion-title -->
				</p><div id="accordion-56-" class="jb-accordion-content collapse" style="height: auto;">
...
<div class="banner-grid h3 w3-card-2">
	  ...
	  <p> “C++ is a statically-typed, free-form, (usually) compiled, multi-paradigm, intermediate-level general-purpose middle-level programming language.”</p>

<p>In simple terms, C++ is a sophisticated, efficient and a general-purpose programming language based on C. It was developed by Bjarne Stroustrup in 1979.</p>

<p>Many of today’s operating systems, system drivers, browsers and games use C++ as their core language. This makes C++ one of the most popular languages today.</p>

<p>Since it is an enhanced/extended version of C programming language, C and C++ are often denoted together as C/C++.</p>
	  </div><br>
	  
	  <div class="banner-grid h3 w3-card-2">
      <h3>C++ LANGUAGE COMPLIER</h3></div>
	  <div class="w3-card-2" style="background-color:#FFFFFF; padding:20px 20px 20px 20px">
	  <p>C++ is completely free and readily available on all platforms.</p>

<p>Follow the tutorial below for running C++ on your computer.</p>

<p>There are multiple compilers and text editors you can use to run C++ programming. These may differ from system to system.</p>

<p>If you want a quick start, you can also run C++ program online.</p>
	  </div><br>
